      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto px-4">
            <div className="group">
              <div className="p-6 md:p-8 bg-white rounded-xl md:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-700 ease-out hover:scale-[1.02] hover:-translate-y-3 border border-gray-100 hover:border-primary/20 relative overflow-hidden h-full">
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <h4 className="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-gray-900 transition-all duration-700 ease-out group-hover:scale-[1.02] group-hover:text-primary">MSME Loans</h4>
                  <p className="text-sm md:text-base text-gray-600 mb-4 md:mb-6 leading-relaxed flex-grow transition-all duration-700 ease-out group-hover:text-gray-700">Fast and flexible financing for Filipino small and medium enterprises with our innovative JAG model.</p>
            ...
            <div className="group">
              <div className="p-6 md:p-8 bg-white rounded-xl md:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-700 ease-out hover:scale-[1.02] hover:-translate-y-3 border border-gray-100 hover:border-secondary/20 relative overflow-hidden h-full">
                {/* Elegant gradient overlay */}
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <h4 className="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-gray-900 transition-all duration-700 ease-out group-hover:scale-[1.02] group-hover:text-secondary">Salary Loans</h4>
                  <p className="text-sm md:text-base text-gray-600 mb-4 md:mb-6 leading-relaxed flex-grow transition-all duration-700 ease-out group-hover:text-gray-700">Convenient financing solutions for employed Filipinos with competitive rates and flexible terms.</p>
            ...
            <div className="group">
              <div className="p-4 md:p-6 bg-white rounded-lg md:rounded-xl shadow-md hover:shadow-lg transition-all duration-700 ease-out hover:scale-[1.02] hover:-translate-y-2 border border-gray-100 hover:border-primary/20 relative overflow-hidden h-full">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <h4 className="text-base md:text-lg font-semibold mb-2 md:mb-3 text-gray-900 transition-all duration-700 ease-out group-hover:scale-[1.02] group-hover:text-primary">Credit Scoring</h4>
                  <p className="text-sm md:text-base text-gray-600 leading-relaxed transition-all duration-700 ease-out group-hover:text-gray-700">AI-powered credit assessment system tailored for the Filipino market and local business patterns.</p>
                </div>
              </div>
            </div>
            ...
            <div className="group">
              <div className="p-4 md:p-6 bg-white rounded-lg md:rounded-xl shadow-md hover:shadow-lg transition-all duration-700 ease-out hover:scale-[1.02] hover:-translate-y-2 border border-gray-100 hover:border-primary/20 relative overflow-hidden h-full">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <h4 className="text-base md:text-lg font-semibold mb-2 md:mb-3 text-gray-900 transition-all duration-700 ease-out group-hover:scale-[1.02] group-hover:text-primary">Risk Management</h4>
                  <p className="text-sm md:text-base text-gray-600 leading-relaxed transition-all duration-700 ease-out group-hover:text-gray-700">Advanced risk analysis and fraud detection tailored for Filipino businesses and market conditions.</p>
                </div>
              </div>
            </div>
            ...
            <div className="group">
              <div className="p-4 md:p-6 bg-white rounded-lg md:rounded-xl shadow-md hover:shadow-lg transition-all duration-700 ease-out hover:scale-[1.02] hover:-translate-y-2 border border-gray-100 hover:border-primary/20 relative overflow-hidden h-full">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <h4 className="text-base md:text-lg font-semibold mb-2 md:mb-3 text-gray-900 transition-all duration-700 ease-out group-hover:scale-[1.02] group-hover:text-primary">Loan Management</h4>
                  <p className="text-sm md:text-base text-gray-600 leading-relaxed transition-all duration-700 ease-out group-hover:text-gray-700">End-to-end loan processing platform designed specifically for Filipino lenders and regulations.</p>
                </div>
              </div>
            </div>
          </div>
