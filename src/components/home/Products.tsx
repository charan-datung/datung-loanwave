  ...
  return (
    <section className="py-20 relative overflow-hidden bg-white">
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Lending Products */}
        <div className="mb-16">
          <h3 className="text-2xl font-semibold text-center mb-8 text-primary">Lending Solutions</h3>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="group">
              <div className="p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300 hover:scale-105 hover:-translate-y-2 border border-gray-100 hover:border-primary/20 relative overflow-hidden">
                {/* 3D Border Effect */}
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">Fast and flexible financing for Filipino small and medium enterprises with our innovative JAG model.</p>
            ...
            <div className="group">
              <div className="p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300 hover:scale-105 hover:-translate-y-2 border border-gray-100 hover:border-primary/20 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">Convenient financing solutions for employed Filipinos with competitive rates and flexible terms.</p>
        ...
        <div>
          <h3 className="text-2xl font-semibold text-center mb-8 text-primary">Technology Solutions</h3>
