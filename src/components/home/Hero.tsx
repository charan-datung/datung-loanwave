...
export const Hero = () => {
  return (
    <PageWrapper
      ...
      className="pt-32 pb-0 px-4 min-h-screen"
    >
      <div className="container mx-auto text-center relative z-10 flex items-center justify-center min-h-screen -mt-16">
        ...
        {/* SEC License Badge */}
        <div className="absolute bottom-16 right-8 flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-3">
