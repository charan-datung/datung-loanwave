    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center gap-4">
            <ContactForm 
              defaultType="demo"
              triggerComponent={
                <Button size="lg" variant="default" className="animate-pulse hover:animate-none">
                  Schedule Demo
                </Button>
              }
            />
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 card-3d">
